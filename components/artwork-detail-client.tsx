...
export default function ArtworkDetailClient({
  ...
  /*
   * Search-result return path.
   *
   * Only internal /search URLs are accepted.
   * This prevents the query parameter becoming
